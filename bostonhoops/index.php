		...
		<div id="main" role="main">
			...
			<div class="project-page-mod">
				<div class="project-page-content">
					...
					<h1>Boston Hoops</h1>
					<p>Somehow a basketball never really ended up in my hands until the Spring of 2013. I didn't have much of a shot but a few blocks, some decent passing and a ton of rebounds made me feel like I had something to contribute. This got me thinking: where else were games going on in the city? Were other spots more or less active? Are there righteous courts to play at night under the lights? I wanted to answer these questions by visiting new parts of town and documenting all of the awesome spots to to shoot hoops. In the process I was able to work on a fun illustration and web project and have something to share with other enthusiasts in the city.</p>
					...
					<p>Research was the first step. I got on my bike and criss crossed the city of Boston shooting hoops at over twenty different courts to start. Even though all of the details haven't yet found their way into version one of Boston Hoops I was taking into account things like court conditions, ease of access and perks to the facilities. So far no two hoops are exactly alike which seems fitting since each court definitely has its own unique personality.</p>
