...
<?php include($_SERVER["DOCUMENT_ROOT"]."/_includes/header.php"); ?>
		...
		<div id="main" role="main">
			<div class="feat-project-mod">
				<img class="feat-project-img" src="/_img/gig-posters-topper.jpg" alt="Lululemon Lead" />
			...
			<div class="project-page-mod">
				<div class="project-page-content">
					...
					<img class="img-full full-m section-start" src="/_img/elephant-six-jp-boneyard.jpg" alt="lululemon wall art 3" />
					...
					<img class="img-full full-m section-start" src="/_img/mount-eerie-palmer-jp-boneyard.jpg" alt="lululemon wall art 3" />
					...
					<img class="img-full full-m section-start" src="/_img/bikes-fight-cancer-jp-boneyard.jpg" alt="lululemon wall art 3" />
					...
					<img class="img-full full-m section-start" src="/_img/golden-girls-jp-boneyard.jpg" alt="lululemon wall art 3" />
					...
					<img class="img-full full-m section-start" src="/_img/jason-anderson-jp-boneyard.jpg" alt="lululemon wall art 3" />
					...
					<img class="img-full full-m section-start" src="/_img/oneida-jp-boneyard.jpg" alt="lululemon wall art 3" />
					...
					<img class="img-full full-m section-start" src="/_img/mount-eerie-boston-jp-boneyard.jpg" alt="lululemon wall art 3" />
