		...
		<div id="main" role="main">
			...
			<div class="project-page-mod">
				<div class="project-page-content">
					...
					<h1>Spark Camp</h1>
					<p>Matt Thompson of NPR reached out to Upstatment about developing a simple web site and branding system that could be used for Spark Camp: a meeting of the minds in the media industry that is held several times throughout each year. Even though the project had a limited time line I was able to jump in, establish the brand elements and build out a site around this new visual language and Matt's content needs. We were fortunate to work with Matt and his appreciation of all the extra details (like building out a set of icons at our suggestion) ultimately led to NPR hiring Upstatement for several other larger projects.</p>	
					


					<img class="img-sm section-start" src="/_img/spark-camp-identity-jp-boneyard-2.jpg" alt="Spark Camp Identity" />

					<h3>Branding</h3>
					<p>Branding took inspiration from the themes based around community, dialogue and the types of imagery that is evoked from sitting around the campfire. Since Spark Camp intended to use their brand on the web, banners, stationary and other printed materials I built out many different components and alternate lockups to work as a flexible brand. The over all vibe is light-hearted and fun—something that Matt acknowledged as an important component of every camp event.</p>	


					<div class="spark-camp-web-mod img-med">
						<a href="http://www.sparkcamp.com" target="_blank">
							<video class="site-video img-med section-start spark-camp-site">
					...
					<btn class="btn-submit btn-txt"> <a href="http://www.sparkcamp.com" target="_blank">Launch The Site</a></btn>
